---
title: "No physical effort model"
...
de1<-read.csv("data/esolution1_no_physical.csv")
#simulated e2-solutions
de2<-read.csv("data/esolution2_no_physical.csv")
#simulated e1-control
dc1<-read.csv("data/esolution_control1_no_physical.csv")
#simulated e2-control
dc2<-read.csv("data/esolution_control2_no_physical.csv")
...
#simulated data
eshort1<-read.csv("data/e1short_no_physical.csv")
eshort2<-read.csv("data/e2short_no_physical.csv")
elong1<-read.csv("data/e1long_no_physical.csv")
elong2<-read.csv("data/e2long_no_physical.csv")
...
#alternated training
ealternating<-read.csv("data/ealternating_no_physical.csv")
#remove X
ealternating$X<-NULL
...
es<-read.csv("data/dev_e1_no_physical.csv")
es$X<-NULL
es<-as.vector(t(es))
ds<-read.csv("data/dev_d1_no_physical.csv")
ds$X<-NULL
ds<-as.vector(t(ds))
