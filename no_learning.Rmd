...
### Simulated plot
```{r}
dd<-rbind(subset(de1, lrate==0.0 & alpha==25), 
          subset(de2, lrate==0.0 & alpha==25),
          subset(dc1, lrate==0.0 & alpha==25), 
          subset(dc2, lrate==0.0 & alpha==25))
...
dd<-rbind(subset(de1, lrate==0.0 & alpha==25), 
          subset(de2, lrate==0.0 & alpha==25),
          subset(de1, lrate==0.0 & alpha==30), 
          subset(de2, lrate==0.0 & alpha==30))
...
### Simulated plot
```{r}
dd<-rbind(subset(eshort1, lrate==0.0 & alpha==15), 
          subset(eshort2, lrate==0.0 & alpha==15),
          subset(elong1, lrate==0.0 & alpha==15), 
          subset(elong2, lrate==0.0 & alpha==15))
...
d1<-rbind(subset(de1, lrate==0.0 & alpha==25), subset(ealternating, lrate==0.0 & alpha==25))
...
dd<-rbind(subset(de1, lrate==0.0 & alpha==25), 
          subset(de2, lrate==0.0 & alpha==25),
          subset(de1, lrate==0.0 & alpha==15), 
          subset(de2, lrate==0.0 & alpha==15))
